...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("chavezcoin.org", "dnsseed.chavezcoin.org"));
        vSeeds.push_back(CDNSSeedData("chavezcoindot.io", "dnsseed.chavezcoindot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("chavezcoinpay.io", "dnsseed.chavezcoinpay.io"));

        // Chavezcoin addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Chavezcoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Chavezcoin private keys start with '7' or 'X'
