 ...
 *
 *   // network
 *   CChavezcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.chavezcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CChavezcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CChavezcoinNetwork(UniValue objIn)
    {
...
// // can be under: ChavezcoinNetwork
// //   -- signature requirements : Key1(User)
// class CChavezcoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == ChavezcoinNetwork);
//     // }
