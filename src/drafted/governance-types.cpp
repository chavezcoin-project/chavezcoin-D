...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ChavezcoinNetwork") type = ChavezcoinNetwork;
    if(strType == "ChavezcoinNetworkVariable") type = ChavezcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ChavezcoinNetwork) s = "ChavezcoinNetwork";
    if(type == ChavezcoinNetworkVariable) s = "ChavezcoinNetworkVariable";
