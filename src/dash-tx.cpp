...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Chavezcoin Core chavezcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  chavezcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded chavezcoin transaction") + "\n" +
              "  chavezcoin-tx [options] -create [commands]   " + _("Create hex-encoded chavezcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded chavezcoin transaction
