...
{
    if(fLiteMode) return; // ignore all Chavezcoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Chavezcoin and make it unusable. To
...
{
    if(fLiteMode) return; // disable all Chavezcoin specific functionality
    ...
    RenameThread("chavezcoin-privatesend");
