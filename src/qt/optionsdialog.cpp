    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CHAVEZCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("CHAVEZCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CHAVEZCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CHAVEZCOIN-traditional"), QVariant("trad"));
