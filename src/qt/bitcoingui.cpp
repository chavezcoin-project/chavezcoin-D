    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Chavezcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Chavezcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and chavezcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Chavezcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Chavezcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Chavezcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Chavezcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Chavezcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a chavezcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Chavezcoin Core help message to get a list with possible Chavezcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Chavezcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Chavezcoin network", "", count));
}
...
{
    QString strTitle = tr("Chavezcoin Core"); // default title
    ...
    // Append title to "Chavezcoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
