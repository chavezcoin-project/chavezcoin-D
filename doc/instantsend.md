...
This mechanism has been integrated into Bitcore-Node-Chavezcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/chavezcoinpay/insight-api-chavezcoin#web-socket-api](https://github.com/chavezcoinpay/insight-api-chavezcoin#web-socket-api) 
* API: [https://github.com/chavezcoinpay/insight-api-chavezcoin#instantsend-transactions](https://github.com/chavezcoinpay/insight-api-chavezcoin#instantsend-transactions) 
...
By default, the Chavezcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Chavezcoin Core daemon:
