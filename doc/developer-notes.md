...
Chavezcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 47047.
...
However, in open source software such as Chavezcoin Core, where everyone uses
...
pay attention to for reviewers of Chavezcoin Core code.

General Chavezcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Chavezcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
